...
public class ZeroOneSystemDbContext :
    AbpDbContext<ZeroOneSystemDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public ZeroOneSystemDbContext(DbContextOptions<ZeroOneSystemDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ConfigureZeroOneSystem();

        /* Configure your own tables/entities inside here */

        //builder.Entity<YourEntity>(b =>
        //{
        //    b.ToTable(ZeroOneSystemConsts.DbTablePrefix + "YourEntities", ZeroOneSystemConsts.DbSchema);
